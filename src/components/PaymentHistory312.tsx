...
import AppMen312 from './AppMenu312';

const PaymentHistory312: React.FC = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const querySnapshot = await getDocs(collection(db, "paymentProofs312")); // Adjust collection name
...
export default PaymentHistory312;

...
import AppMenu202 from './AppMenu202'; // Assuming you have a similar component for Room202
import { collection, getDocs } from 'firebase/firestore';
import { db } from '../firebaseConfig';
import './PaymentHistory201.css'; // Import your CSS file

const PaymentHistory202: React.FC = () => {
...
export default PaymentHistory202;

...
const HouseInfo206 = () => {
    ...
    const fetchInvoices = async () => {
        try {
            const querySnapshot = await getDocs(collection(db, "invoices206")); // Use a different collection name
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (editingId) {
                ...
                const invoiceRef = doc(db, "invoices206", editingId); // Use a different collection name
                ...
                // Add new invoice
                await addDoc(collection(db, "invoices206"), invoiceData); // Use a different collection name
    ...
    const toggleStatus = async (invoice: Invoice) => {
        try {
            const invoiceRef = doc(db, "invoices206", invoice.id!); // Use a different collection name
    ...
    const handleDelete = async (id: string) => {
        try {
            await deleteDoc(doc(db, "invoices206", id)); // Use a different collection name

...
import AppMen314 from './AppMenu314';

const PaymentHistory314: React.FC = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const querySnapshot = await getDocs(collection(db, "paymentProofs314")); // Adjust collection name
...
export default PaymentHistory314;

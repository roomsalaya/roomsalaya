...
import AppMen309 from './AppMenu309';

const PaymentHistory309: React.FC = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const querySnapshot = await getDocs(collection(db, "paymentProofs309")); // Adjust collection name
...
export default PaymentHistory309;

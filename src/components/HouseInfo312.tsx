...
const HouseInfo312 = () => {
    ...
    const fetchInvoices = async () => {
        try {
            const querySnapshot = await getDocs(collection(db, "invoices312")); // Use a different collection name
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (editingId) {
                ...
                const invoiceRef = doc(db, "invoices312", editingId); // Use a different collection name
                ...
                // Add new invoice
                await addDoc(collection(db, "invoices312"), invoiceData); // Use a different collection name
    ...
    const toggleStatus = async (invoice: Invoice) => {
        try {
            const invoiceRef = doc(db, "invoices312", invoice.id!); // Use a different collection name
    ...
    const handleDelete = async (id: string) => {
        try {
            await deleteDoc(doc(db, "invoices312", id)); // Use a different collection name

...
import AppMen225 from './AppMenu225';

const PaymentHistory225: React.FC = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const querySnapshot = await getDocs(collection(db, "paymentProofs225")); // Adjust collection name
...
export default PaymentHistory225;

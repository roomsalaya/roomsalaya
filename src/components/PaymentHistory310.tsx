...
import AppMen310 from './AppMenu310';

const PaymentHistory310: React.FC = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const querySnapshot = await getDocs(collection(db, "paymentProofs310")); // Adjust collection name
...
export default PaymentHistory310;

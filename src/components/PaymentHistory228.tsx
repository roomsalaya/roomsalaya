...
import AppMen228 from './AppMenu228';

const PaymentHistory228: React.FC = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const querySnapshot = await getDocs(collection(db, "paymentProofs228")); // Adjust collection name
...
export default PaymentHistory228;

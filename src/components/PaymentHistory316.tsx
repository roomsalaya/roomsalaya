...
import AppMen316 from './AppMenu316';

const PaymentHistory316: React.FC = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const querySnapshot = await getDocs(collection(db, "paymentProofs316")); // Adjust collection name
...
export default PaymentHistory316;

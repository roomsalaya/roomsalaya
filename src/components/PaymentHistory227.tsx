...
import AppMen227 from './AppMenu227';

const PaymentHistory227: React.FC = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const querySnapshot = await getDocs(collection(db, "paymentProofs227")); // Adjust collection name
...
export default PaymentHistory227;
